...
aesthetic_check = pls_analysis_check(tab[[1]][["traits_dfs_pls"]])
narrative_check = pls_analysis_check(tab[[2]][["traits_dfs_pls"]])
goals_check     = pls_analysis_check(tab[[3]][["traits_dfs_pls"]])
```
